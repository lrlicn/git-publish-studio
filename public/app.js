...
function renderSnapshot() {
  ...
  elements['upstream-name'].textContent = snapshot.upstream || '未跟踪远端'
  elements['ahead-count'].textContent = snapshot.ahead || 0
  elements['behind-count'].textContent = snapshot.behind || 0
